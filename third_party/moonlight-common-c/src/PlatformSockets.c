...
#if defined(LC_WINDOWS) && defined(_WIN32_WINNT) && _WIN32_WINNT < 0x0600
const char* inet_ntop(int af, const void* src, char* dst, socklen_t size) {
    if (af == AF_INET) {
        ...
        if (WSAAddressToStringA((struct sockaddr*)&sin, sizeof(sin), NULL, dst, &s) == 0) {
            return dst;
        }
    }
#ifdef AF_INET6
        ...
        if (WSAAddressToStringA((struct sockaddr*)&sin6, sizeof(sin6), NULL, dst, &s) == 0) {
            return dst;
        }
    }
#endif
...
int inet_pton(int af, const char* src, void* dst) {
    if (af == AF_INET) {
        ...
        memset(&sin, 0, sizeof(sin));
        sin.sin_family = AF_INET;
        if (WSAStringToAddressA((char*)src, AF_INET, NULL, (struct sockaddr*)&sin, &s) == 0) {
        ...
        memset(&sin6, 0, sizeof(sin6));
        sin6.sin6_family = AF_INET6;
        if (WSAStringToAddressA((char*)src, AF_INET6, NULL, (struct sockaddr*)&sin6, &s) == 0) {
